The deployifnotexists-defemder-for-vm policy will run a scan of all subscriptions in your tenant to identify the one's wthout defender for servers enabled. 
